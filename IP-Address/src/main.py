...
from src.excel_builder import ExcelBuilder
...
if __name__ == "__main__":
    ...
    print(Gil_IP)
    # custom_str = input("Введите свою фамилию (English):\n")
    # print("\n" * 3)
    # custom_ip = MyIP(uname=custom_str)
    # print(custom_ip)
    ...
    excel_build = ExcelBuilder(ip_object)
    subnets = excel_build.subnets
    print(excel_build.parse_bs4())
